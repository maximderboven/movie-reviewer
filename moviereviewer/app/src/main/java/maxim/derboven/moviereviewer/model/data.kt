...
fun getMovies(): Array<Movie> {
    return arrayOf(
        ...
        Movie(14,true,"Rogue One: A Star Wars Story", LocalDate.of(2022,12,16),130,Mediatype.SERIES,"The Rebellion makes a risky move to steal the plans to the Death Star, setting up the epic saga to follow.","starwars"),
    );
}